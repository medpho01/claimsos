...
router.route("/getPatients").get(AuthMiddleware.checkHospital, PatientController.getPanelPatientsPaginated);
router.route("/getTabCounts").get(AuthMiddleware.checkAuth, PatientController.getTabCounts);

...
const SETS: SeedSet[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      {
        ruleId: 'OT_PHOTO_DOCTOR_PATIENT',
        name: 'OT/patient photo shows doctor and patient',
        kind: 'EVIDENCE_CHECK',
        ...
        minConfidence: 0.6,
        params: {
          category: 'gps_tagged_patient_photos',
          assertion: 'A treating doctor and the patient are both clearly visible together in the same photograph.',
          maxImages: 2,
        },
        failure: 'The OT/patient photo does not clearly show both a doctor and the patient.',
      },
      NAME_MATCH,
    ],
  },

...
type IpdFormData = z.infer<typeof ipdFormSchema>;
type ClaimsFormData = z.infer<typeof claimsFormSchema>;
...
const PatientPhotosModal: React.FC<PatientPhotosModalProps> = ({ patient, onClose, onUpdate }) => {
  ...
  // IPD form with React Hook Form + Zod
  const ipdForm = useForm<IpdFormData>({
    resolver: zodResolver(ipdFormSchema),
    defaultValues: {
      phone: patient.phone || "",
      beneficiaryId: patient.beneficiary_id || "",
      admissionType: (patient.admission_type as "" | "conservative" | "surgical") || "",
    },
    mode: "onChange",
  });

  // Claims form with React Hook Form + Zod
                  ...
                  {mainTab === "ipd" ? (
                    <>
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="text"
                          {...ipdForm.register("phone")}
                          placeholder="e.g., 9876543210"
                          maxLength={10}
                          className={ipdForm.formState.errors.phone ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {ipdForm.formState.errors.phone && (
                          <p className="text-sm text-red-500 flex items-center gap-1">
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" /><path d="M12 8v4M12 16h.01" /></svg>
                            {ipdForm.formState.errors.phone.message}
                          </p>
                        )}
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="text"
                          {...ipdForm.register("beneficiaryId")}
                      ...
                      <div className="grid gap-2">
                        ...
                        <select
                          {...ipdForm.register("admissionType")}
                    ...
                    <>
                      <div className="grid gap-2 col-span-1 md:col-span-2">
                        ...
                        <textarea
                          {...claimsForm.register("treatmentPlan")}
                      ...
                      <div className="grid gap-2 col-span-1 md:col-span-2">
                        ...
                        <Input
                          type="text"
                          {...claimsForm.register("latestStatus")}
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="number"
                          {...claimsForm.register("claimAmount")}
                          placeholder="e.g., 122860"
                          step="0.01"
                          min="0"
                          className={claimsForm.formState.errors.claimAmount ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {claimsForm.formState.errors.claimAmount && (
                          <p className="text-sm text-red-500">{claimsForm.formState.errors.claimAmount.message}</p>
                        )}
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="number"
                          {...claimsForm.register("claimApproved")}
                          placeholder="e.g., 100000"
                          step="0.01"
                          min="0"
                          className={claimsForm.formState.errors.claimApproved ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {claimsForm.formState.errors.claimApproved && (
                          <p className="text-sm text-red-500">{claimsForm.formState.errors.claimApproved.message}</p>
                        )}
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="number"
                          {...claimsForm.register("incentive")}
                          placeholder="e.g., 5000"
                          step="0.01"
                          min="0"
                          className={claimsForm.formState.errors.incentive ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {claimsForm.formState.errors.incentive && (
                          <p className="text-sm text-red-500">{claimsForm.formState.errors.incentive.message}</p>
                        )}
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="number"
                          {...claimsForm.register("deduction")}
                          placeholder="e.g., 2000"
                          step="0.01"
                          min="0"
                          className={claimsForm.formState.errors.deduction ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {claimsForm.formState.errors.deduction && (
                          <p className="text-sm text-red-500">{claimsForm.formState.errors.deduction.message}</p>
                        )}
                      </div>
                      <div className="grid gap-2 col-span-1 md:col-span-2">
                        ...
                        <Input
                          type="text"
                          {...claimsForm.register("deductionReason")}
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="number"
                          {...claimsForm.register("claimSettled")}
                          placeholder="e.g., 98000"
                          step="0.01"
                          min="0"
                          className={claimsForm.formState.errors.claimSettled ? "border-red-500 focus-visible:ring-red-500" : ""}
                        />
                        {claimsForm.formState.errors.claimSettled && (
                          <p className="text-sm text-red-500">{claimsForm.formState.errors.claimSettled.message}</p>
                        )}
                      </div>
                      <div className="grid gap-2">
                        ...
                        <Input
                          type="date"
                          {...claimsForm.register("claimSettledDate")}
                        />
                      </div>
                    </>
                  )}

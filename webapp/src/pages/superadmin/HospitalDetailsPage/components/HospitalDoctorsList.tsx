...
import { Loader2, Plus, UserCircle2, Settings, Trash2, Mail, Phone } from "lucide-react";
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h3 className="text-xl font-semibold text-slate-800">Hospital Doctors</h3>
                    <p className="text-sm text-slate-500 mt-1">Manage doctor profiles and their documents</p>
                </div>
            ...
            {doctors.length === 0 ? (
                <div className="bg-white rounded-xl border border-slate-200 p-16 text-center flex flex-col items-center">
                    ...
                    <h4 className="text-slate-800 font-semibold text-lg mb-2">No doctors found</h4>
                    <p className="text-slate-500 text-sm max-w-sm mb-6">
                        Add a doctor to start managing their details, specialties, and professional documents.
                    </p>
                    <Button onClick={() => setIsAddModalOpen(true)} className="gap-2 bg-indigo-600 hover:bg-indigo-700">
                        <Plus className="h-4 w-4" /> Add Doctor
                    </Button>
